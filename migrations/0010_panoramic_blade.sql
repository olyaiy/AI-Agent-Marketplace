...
ALTER TABLE "conversation" ADD CONSTRAINT "conversation_agent_tag_agent_tag_fk" FOREIGN KEY ("agent_tag") REFERENCES "public"."agent"("tag") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
