    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar md:flex min-h-svh  w-full",
            className
          )}
          {...props}
        >
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "in-data-[side=left]:cursor-w-resize in-data-[side=right]:cursor-e-resize cursor-pointer",
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background  md:p-4 relative flex w-full flex-1 flex-col border border-1 shadow-xl",
